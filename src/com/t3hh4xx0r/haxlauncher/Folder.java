...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
        View.OnLongClickListener, DropTarget, FolderListener, StyledTextFoo.OnEditorActionListener,
    ...
    public boolean onLongClick(View v) {
        ...
        if (tag instanceof ShortcutInfo) {
            ...
            mIconDrawable = ((StyledTextFoo) v).getCompoundDrawables()[1];
    ...
    public boolean onEditorAction(StyledTextFoo v, int actionId, KeyEvent event) {
    ...
    // of keyboard focus
    private void updateStyledTextFooFocus() {
